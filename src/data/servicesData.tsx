...
export const services = [
  {
    title: 'UI/UX Design',
    description:
      'Next-gen designs tailored for future-proof, responsive, and interactive web/mobile apps.',
    icon: (
      <svg
...

  {
    ...
    description:
      'Scalable MERN-based apps optimized for performance, accessibility, and UX delight.',
    icon: (
      <div
        className="text-cyan-400 mb-4 text-6xl font-bold"
        style={{ fontFamily: 'Inter', fontSize: '36px', lineHeight: '44px' }}
      >
        &lt;/&gt;
      </div>
    ),
